const styles = {
  ...
  heroHeadText:
    'font-black text-eerieBlack lg:text-[50px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[90px] mt-2',
  heroSubText:
  'text-eerieBlack font-medium lg:text-[24px] sm:text-[20px] xs:text-[16px] text-[12px] lg:leading-[32px]',
